...
const onTreatUse = async (
  ...
  let inventory = Store.getState().inventory;
  let trainingData = Store.getState().training.trainingData;
  let timesTrainedToday = Store.getState().intelligence.timesTrainedToday;
...
export const SHOP_ITEM_INFO = {
  ...
  apple: {
    ...
    onUse: async (dispatch, command, attempt, outcome) => {
      await onTreatUse(dispatch, 1, 'apple', command, attempt, outcome);
    },
  },
  milkBone: {
    id: 'milkBone',
    ...
    onUse: async (dispatch, command, attempt, outcome) => {
      await onTreatUse(dispatch, 1, 'milkBone', command, attempt, outcome);
    },
  },
  peanutButter: {
    id: 'peanutButter',
    ...
    onUse: async (dispatch, command, attempt, outcome) => {
      await onTreatUse(dispatch, 1, 'peanutButter', command, attempt, outcome);
    },
  },
  antibidogics: {
    id: 'antibidogics',
