...
export const createNewAccountWithUsernameAndPassword = async (
  username,
  password,
  setErrorMsg
) => {
...
export const updateInventory = async () => {
  ...
  await db.collection('Users').doc(uid).update(inventory);
};
...
export const refreshHungerInfoBackend = async ({
  timesFedToday,
  hungerStars,
  didMisfeed,
}) => {
...
export const refreshExerciseInfoBackend = async ({
  timesExercisedToday,
  didMisexercise,
  exerciseStars,
}) => {
...
export const refreshCleanlinessInfoBackend = async ({
  timesCleanedToday,
  didMisclean,
  cleanlinessStars,
}) => {
...
export const feedPetBackend = async ({
  lastFed,
  didMisfeed,
  timesFedToday,
}) => {
...
export const exercisePetBackend = async ({
  lastExercised,
  didMisexercise,
  timesExercisedToday,
}) => {
...
export const cleanPetBackend = async ({
  lastCleaned,
  didMisclean,
  timesCleanedToday,
}) => {
...
export const firebaseLearn = async (trainingData, timesTrainedToday) => {
  let uid = Store.getState().userID;
  let updateObject = {
    trainingData: trainingData,
    timesTrainedToday: timesTrainedToday + 1,
  };
