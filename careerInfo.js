...
petted and handled, sometimes clumsily.",
        ...
        icon: <Icon type='FontAwesome5' name='heart' style={{ fontSize: ICON_SIZE }} />

    },
    'service': {
        id: 'service',
        displayString: 'Service',
        description: 'A service animal means any dog that is individually \
...
and under control in the community.',
        ...
        primaryColor: '#e6ac00',
        secondaryColor: 'white',
        icon: <Icon type='FontAwesome5' name='plus' style={{ fontSize: ICON_SIZE }} />
    },
    'herding': {
        id: 'herding',
        displayString: 'Herding',
        description: 'A herding dog or pastoral breed is a dog that either \
...
although it is not unusual for poultry to be handled by dogs.',
        ...
        primaryColor: '#009933',
        secondaryColor: 'white',
        icon: <Icon type='MaterialCommunityIcons' name='sheep' style={{ fontSize: ICON_SIZE }} />
    },
    'hollywood': {
        id: 'hollywood',
        ...
        primaryColor: '#cc0000',
        secondaryColor: 'white',
        icon: <Icon type='FontAwesome' name='star' style={{ fontSize: ICON_SIZE }} />
    },
    'rescue': {
        id: 'rescue',
        displayString: 'Search and Rescue',
        description: 'Search and rescue dogs spring into action assisting \
...
circumstances and work well under pressure.',
        ...
        primaryColor: '#b3ecff',
        secondaryColor: 'white',
        icon: <Icon type='FontAwesome5' name='life-ring' style={{ fontSize: ICON_SIZE }} />
    },
    'detection': {
        id: 'detection',
        displayString: 'Detection',
        description: 'A detection dog or sniffer dog is a dog that is trained \
...
average dog. They are trained to have this great sense of smell.',
        ...
        primaryColor: '#bfbfbf',
        secondaryColor: 'white',
        icon: <Icon type='FontAwesome5' name='bomb' style={{ fontSize: ICON_SIZE }} />
    },
    'truffle': {
        id: 'truffle',
        displayString: 'Truffle Sniffing',
        description: "Truffles are a variety of edible fungus which can cost as much \
...
need to be well-fed to prevent them from eating their findings.",
        ...
        primaryColor: '#FFFDD0',
        secondaryColor: 'white',
        icon: <Icon type='MaterialCommunityIcons' name='mushroom' style={{ fontSize: ICON_SIZE }} />
    }
}