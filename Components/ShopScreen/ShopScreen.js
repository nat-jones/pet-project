...
import {
    SHELF_WINDOW_HEIGHT,
    WINDOW_HEIGHT,
    WINDOW_WIDTH, WINDOW_BOTTOM_MARGIN,
    SIGN_FOOTER_HEIGHT,
    SIGN_HEIGHT,
    WINDOW_TOP_MARGIN, width, height,
} from '../../layoutConsts';
                ...
                >
                    <View style={[styles.shopSign, styles.centerChildren]}>
                        <View style={[styles.centerChildren, styles.coinView]}>
                            ...
                            <Icon type='FontAwesome5' name='money-bill-wave' style={[styles.moneyIcon, styles.centerChildren]} />
