    ...
    if (menuState == 'Work') {
      return (
        <>
          <TouchableOpacity
            ...
            onPress={() => dispatchShift('short')}
          >
            <Text style={styles.buttonText}>Work a Short Shift</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.shiftButton}
            onPress={() => dispatchShift('medium')}
          >
            <Text style={styles.buttonText}>Work a Medium Shift</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.shiftButton}
            onPress={() => dispatchShift('long')}
          >
            <Text style={styles.buttonText}>Work a Long Shift</Text>
          </TouchableOpacity>
        </>
      );
    } else {
      return (
        <>
          <TouchableOpacity
            style={styles.shiftButton}
            onPress={() => setMenuState('Work')}
          >
            <Text style={styles.buttonText}>Go To Work</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.shiftButton}
            onPress={() => props.setShowCareerSelection(true)}
          >
            <Text style={styles.buttonText}>Change Career</Text>
          </TouchableOpacity>
        </>
      );
    }
